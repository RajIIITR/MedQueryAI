    ...
    if st.button("Analyze Image"):
        ...
        with st.spinner("Analyzing image..."):
            try:
                ...
                Perform a detailed medical analysis of this body-related image:

                Strict Medical Assessment Criteria:
                1. Identify the body system or region shown
                2. Detect and describe any visible medical conditions
                3. Identify the name of the medical condition on the basis of uploaded sample image
                4. Analyze symptoms or physical manifestations
                5. Provide potential diagnostic insights

                Specific Focus Areas:
                - Skin conditions (rashes, infections, lesions)
                - Respiratory symptoms (signs of cold, flu, pneumonia)
                - Infectious disease manifestations
                - Physical symptoms of inflammation or illness
                - Visible medical conditions affecting:
                - Skin
                - Respiratory system
                - Viral or bacterial infections
                - External physical health indicators

                Important Guidelines:
                - Use medical terminology precisely
                - Describe observed symptoms objectively
                - Do not provide a definitive diagnosis
                - Highlight key visual indicators of the condition
